...
- A shared :class:`energy_middleware.models.EnergyMiddleware` instance (``tracker``)
...
This returns a list of :class:`energy_middleware.middleware.EnergyDataPoint` objects, each representing
a single model call.
